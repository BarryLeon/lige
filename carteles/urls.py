...
urlpatterns = [
    ...
    path("<int:pk>/corregir-distancia/", views.corregir_distancia_y_reprocesar, name="carteles_corregir_distancia"),
    path("<int:pk>/esquinas-manuales/", views.guardar_esquinas_manuales, name="carteles_esquinas_manuales"),
    path("<int:pk>/esquinas-manuales/quitar/", views.quitar_esquinas_manuales, name="carteles_esquinas_manuales_quitar"),
